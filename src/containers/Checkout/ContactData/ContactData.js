...
class ContactData extends Component {
  ...
  inputChangedHandler = (event, inputIdentifier) => {
    const updatedFormOrder = { ...this.state.orderForm };
    const updatedFormElement = { ...updatedFormOrder[inputIdentifier] };
    ...
    this.setState({ orderForm: updatedFormOrder, formIsValid });
  }
